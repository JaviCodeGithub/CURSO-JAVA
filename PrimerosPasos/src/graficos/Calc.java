...
public class Calc {
	...
	public static void main(String[] args) {
		...
		//MODIFICANDO CODIGO DESDE GITHUB

		CalcFrame2 calcFrame = new CalcFrame2();
...
class CalcFrame2 extends JFrame{
	...
	public CalcFrame2()	{		
		...
		Image icon = Toolkit.getDefaultToolkit().getImage("PrimerosPasos/src/graficos/calculator.png");
